...
public class MainMenu {
	...
	public MainMenu() {
		...
		img = new Texture("../core/assets/mainmenubg2.png");
		...
		startGame = new MenuButton(screenWidth/2-80, screenHeight/2+40, 160, 40, new Color(0.15f, 0.3f, 0.5f, 1), new Color(0.3f, 0.6f, 1f, 1));
		highScores = new MenuButton(screenWidth/2-80, screenHeight/2-20, 160, 40, new Color(0.15f, 0.3f, 0.5f, 1), new Color(0.3f, 0.6f, 1f, 1));
		quitGame = new MenuButton(screenWidth/2-80, screenHeight/2-80, 160, 40, new Color(0.15f, 0.3f, 0.5f, 1), new Color(0.3f, 0.6f, 1f, 1));
	}
